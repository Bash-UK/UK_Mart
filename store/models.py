...
class OrderItem(models.Model):
    ...
    unit_price = models.DecimalField(max_digits=6, decimal_places=2) # Store the price at the time of order
...
class Promotion(models.Model):
    ...
    discount = models.FloatField()  # e.g., 10.00 for a 10% discount
